...
@Entity(name = "InvoiceItemLot")
@Table(name = "INV_INVOICE_ITEM_LOT", indexes = @Index(columnList = "INVOICE_ITEM_ID"))
@Data
...
@NoArgsConstructor
@Builder
public class InvoiceItemLotEntity implements Serializable {
  ...
  @AttributeOverrides({
    @AttributeOverride(name = "value", column = @Column(name = "ITEM_LOT_CODE", length = TypeDefinitions.CODE_LENGTH))
  })
